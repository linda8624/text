 ...
 *  Status bar height.
 */
#define  BAKit_StatusBarHeight      20.0f

/**
 *  Navigation bar height.
 */
#define  BAKit_NavigationBarHeight  44.0f

/**
 *  Tabbar height.
 */
#define  BAKit_TabbarHeight         49.0f

/**
 *  Status bar & navigation bar height.
 */
#define  BAKit_StatusBarAndNavigationBarHeight   (20.f + 44.f)
 ...
 */
CG_INLINE CGSize
BAKit_LabelSizeWithMutableAttributedStringAndWidthAndFont(NSAttributedString *text, CGFloat width, UIFont *font){
    CGSize size = CGSizeMake(width, MAXFLOAT);
    NSMutableParagraphStyle *style = [[NSMutableParagraphStyle alloc] init];
    [style setLineBreakMode:NSLineBreakByWordWrapping];
